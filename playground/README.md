...
GitHub Pages for this repo is a project site at `/usethishook/`. CI runs `npm run playground:build:pages` and deploys `playground/dist` via [`.github/workflows/pages.yml`](../.github/workflows/pages.yml). Enable **Settings → Pages → GitHub Actions** once.
